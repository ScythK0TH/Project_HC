		...
		<div class="info">
			...
			<div style="padding-top: 2vh; padding-bottom: 2vh;" class="container">
				...
				<label class="label" for="bear">
					<input id="bear" type="radio" name="pcolor" value="Green" on:click={resetCount} required />
				...
				<label class="label" for="mickey">
					<input id="mickey" type="radio" name="pcolor" value="Blue" on:click={resetCount} required />
				...
				<label class="label" for="white">
					<input id="white" type="radio" name="pcolor" value="White" on:click={resetCount} required />
				...
				<label class="label" for="black">
					<input id="black" type="radio" name="pcolor" value="Black" on:click={resetCount} required />
